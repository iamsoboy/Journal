<x-guest-layout>
    ...
    <section>
        <!-- SLIDER START-->
        <div class="h-[639px] relative mb-4 z-10 mx-auto max-w-[1030px]">
            <div id="default-carousel" class="h-[639px] relative w-full" data-carousel="slide">
            <!-- Carousel wrapper -->
            <div class="relative overflow-hidden rounded-lg h-[639px]">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img
                        src="{{ config('app.url').'/storage/'.$slider->image }}"
                        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 h-[639px] w-[540px] "
                        alt="{{$slider->name}}"
                    >
                </div>
                @endforeach
