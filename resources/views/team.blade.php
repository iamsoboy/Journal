            ...
            <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                    <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                        ...
                        <div class="flex-grow">
                            <h2 class="text-gray-900 title-font font-medium uppercase">{{ $member->surname }}, {{ $member->other_names }} {{ $member->first_name }}</h2>
                            <p class="text-gray-500">{{ $member->title }}</p>
                            <p class="text-gray-500">{{ $member->school }}</p>
                            <p class="text-gray-500">{{ $member->address }}</p>
                        </div>
                    </div>
                </div>
                @empty
