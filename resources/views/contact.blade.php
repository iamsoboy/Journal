<x-guest-layout>
    ...
    <section class="text-gray-600 body-font relative">
        <div class="px-5 py-4 mx-auto h-auto flex flex-col">
            <div class="xs:hidden bg-gray-300 rounded-lg overflow-hidden p-10 flex items-center justify-center relative">
                ...
                <div class="bg-white relative flex py-6 rounded shadow-md">
                    <div class="lg:w-1/2 px-6">
                        ...
                        <p class="mt-1">134 Hardman Ave NSouth St Paul, MN 55075, USA</p>
                    </div>
                    <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                        <a class="text-indigo-500 leading-relaxed">info@iigdpublishers.com</a>
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                        <p class="leading-relaxed">651-450-6868</p>
                    </div>
                </div>
                </div>
            </div>

            <div class="sm:flex-col sm:hidden bg-white relative py-1 rounded shadow-md">
                <div class="p-2">
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
                    <p class="mt-1">134 Hardman Ave NSouth St Paul, MN 55075, USA</p>
                </div>
                <div class="p-2 mt-4 lg:mt-0">
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                    <a class="text-indigo-500 text-sm">info@iigdpublishers.com</a>
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                    <p class="leading-relaxed">651-450-6868</p>
                </div>
            </div>

            <div class="bg-white max-w-4xl mx-auto w-full md:py-8 mt-8 md:mt-0">
