        ...
        <div class="flex flex-col lg:flex-row lg:space-x-12 pb-6">
            <div class="order-last w-full max-w-screen-sm m-auto mt-12 lg:w-1/4 lg:order-first">
                <div class="p-4 transition duration-500 ease-in-out transform bg-white border rounded-lg">
                    ...
                    <div class="flex flex-col rounded-md shadow-sm py-4" role="group">

                        <a href="{{ config('app.url')."/storage/".$journal->template }}" target="_blank" type="button" class="no-underline inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Download Template
                            <span class="inline-flex items-center justify-center ml-4 rounded-full">
                            <svg class="w-4 h-4 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                <path
                                    ...
                                    stroke-width="2" d="M7.75 4H19M7.75 4a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 4h2.25m13.5 6H19m-2.25 0a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 10h11.25m-4.5 6H19M7.75 16a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 16h2.25"/>
                            </svg>
                            </span>
                        </a>
